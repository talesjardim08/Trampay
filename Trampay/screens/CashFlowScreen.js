    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.forecastSection}>
          ...
          {/* Bar Chart - Lucros vs Despesas */}
          <View style={styles.barChartContainer}>
            <Text style={styles.barChartTitle}>Proporção Lucros x Despesas</Text>
            <BarChart
              data={[
                { 
                  label: 'Lucros', 
                  value: forecast[forecastTab].income, 
                  color: colors.success 
                },
                { 
                  label: 'Despesas', 
                  value: forecast[forecastTab].expenses, 
                  color: colors.danger 
                }
              ]}
              width={width - 60}
