// Modal para editar cliente existente - Trampay
...
const EditClientModal = ({ visible, onClose, onUpdate, client }) => {
  ...
  // Preenche o formulário com os dados do cliente quando o modal abre
  useEffect(() => {
    if (visible && client) {
      setFormData({
        name: client.name || '',
